...
from openpilot.system.ui.hoofpilot.lib.utils import AlertFadeAnimator
...
class SpeedLimitAlertRenderer:
  ...
  def __init__(self):
    self.arrow_up = gui_app.texture("../../hoofpilot/selfdrive/assets/img_plus_arrow_up.png", self.ARROW_SIZE, self.ARROW_SIZE)
    self.arrow_down = gui_app.texture("../../hoofpilot/selfdrive/assets/img_minus_arrow_down.png", self.ARROW_SIZE, self.ARROW_SIZE)
