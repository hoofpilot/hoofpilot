...
from openpilot.selfdrive.ui.hoofpilot.layouts.settings.cruise_sub_layouts.speed_limit_settings import SpeedLimitSettingsLayout
from openpilot.selfdrive.ui.ui_state import ui_state
from openpilot.system.ui.lib.multilang import tr, tr_noop
from openpilot.system.ui.hoofpilot.widgets.list_view import toggle_item_sp, option_item_sp, simple_button_item_sp
...
ICBM_DESC = tr_noop("When enabled, hoofpilot will attempt to manage the built-in cruise control buttons " +
...
ICMB_UNAVAILABLE_LONG_AVAILABLE = tr_noop("Disable the hoofpilot Longitudinal Control (alpha) toggle to allow Intelligent Cruise Button Management.")
ICMB_UNAVAILABLE_LONG_UNAVAILABLE = tr_noop("hoofpilot Longitudinal Control is the default longitudinal control for this platform.")

ACC_ENABLED_DESCRIPTION = tr_noop("Enable custom Short & Long press increments for cruise speed increase/decrease.")
ACC_NOLONG_DESCRIPTION = tr_noop("This feature can only be used with hoofpilot longitudinal control enabled.")
...
class CruiseLayout(Widget):
  ...
  def _initialize_items(self):
    ...
    self.dec_toggle = toggle_item_sp(
      ...
      description=tr("Enable toggle to allow the model to determine when to use hoofpilot ACC or hoofpilot End to End Longitudinal."),
