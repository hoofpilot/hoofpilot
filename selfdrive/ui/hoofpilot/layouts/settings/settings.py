...
from openpilot.selfdrive.ui.hoofpilot.layouts.settings.device import DeviceLayoutSP
from openpilot.selfdrive.ui.hoofpilot.layouts.settings.display import DisplayLayout
...
class SettingsLayoutSP(OP.SettingsLayout):
  def __init__(self):
    ...
    self._panels = {
      ...
      OP.PanelType.NAVIGATION: PanelInfo(tr_noop("Navigation"), NavigationLayout(), icon="../../hoofpilot/selfdrive/assets/navigation/direction_continue_right.png"),
