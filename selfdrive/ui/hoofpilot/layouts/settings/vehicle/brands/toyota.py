...
SNG_HACK_UNAVAILABLE = tr_noop("hoofpilot Longitudinal Control must be available and enabled for your vehicle to use this feature.")
...
DESCRIPTIONS = {
  ...
  'stop_and_go_hack': tr_noop(
    'hoofpilot will allow some Toyota/Lexus cars to auto resume during stop and go traffic. ' +
