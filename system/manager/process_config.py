...
procs = [
  ...
  PythonProcess("modeld", "hoofpilot.modeld_v2.modeld", and_(only_onroad, is_stock_model)),
  NativeProcess("modeld_tinygrad", "hoofpilot/modeld_v2", ["./modeld"], and_(only_onroad, is_tinygrad_model)),
  PythonProcess("dmonitoringmodeld", "hoofpilot.modeld_v2.dmonitoringmodeld", driverview, enabled=(WEBCAM or not PC)),
