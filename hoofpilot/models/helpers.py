...
from openpilot.hoofpilot.models.constants import Meta, MetaTombRaider, MetaSimPose
...
def get_active_bundle(params: Params = None) -> custom.ModelManagerSP.ModelBundle:
  ...
  try:
    ...
    if active_bundle and is_bundle_version_compatible(active_bundle):
    ...
    cloudlog.exception(f"Failed to parse active bundle: {e}")
