...
from openpilot.hoofpilot.sunnylink.athena.sunnylinkd import METADATA_PATH
...
def test_torque_control_tune_versions_in_sync():
  ...
  versions_json_path = os.path.join(BASEDIR, "hoofpilot", "selfdrive", "controls", "lib", "latcontrol_torque_versions.json")
  sync_script_path = "python3 hoofpilot/sunnylink/tools/sync_torque_versions.py"
