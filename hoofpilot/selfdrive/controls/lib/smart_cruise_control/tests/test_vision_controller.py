...
from openpilot.hoofpilot.selfdrive.controls.lib.smart_cruise_control import MIN_V
from openpilot.hoofpilot.selfdrive.controls.lib.smart_cruise_control.vision_controller import SmartCruiseControlVision, _ENTERING_PRED_LAT_ACC_TH
